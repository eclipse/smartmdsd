...
public class ComponentDependencyGraphExtensionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ComponentDependencyGraphExtensionPackage.COMPONENT_DEPENDENCY_OBJECT: {
			ComponentDependencyObject componentDependencyObject = (ComponentDependencyObject) theEObject;
			T result = caseComponentDependencyObject(componentDependencyObject);
			if (result == null)
				result = caseComponentPortExtension(componentDependencyObject);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Component Dependency Object</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Component Dependency Object</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComponentDependencyObject(ComponentDependencyObject object) {
		return null;
	}
...
} //ComponentDependencyGraphExtensionSwitch
