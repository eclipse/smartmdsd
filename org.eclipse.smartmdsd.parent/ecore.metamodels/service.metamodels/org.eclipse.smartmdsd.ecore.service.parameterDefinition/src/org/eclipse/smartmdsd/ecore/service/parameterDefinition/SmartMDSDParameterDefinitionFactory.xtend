...
class SmartMDSDParameterDefinitionFactory implements ISmartMDSDModelFactory {
	...
	override createDefaultModel(String projectName, Collection<EObject> parentModels) {
		val model = ParameterDefinitionFactory.eINSTANCE.createParamDefModel();
		val repo = ParameterDefinitionFactory.eINSTANCE.createParameterSetRepository();
